      ...
      leftSidebar={
        <div className="space-y-6 flex flex-col h-full">
          ...
          <nav className="flex flex-col space-y-2 px-4 flex-1">
             <button onClick={() => { navigate('/'); setSelectedPostId(undefined) }} className="flex items-center gap-4 px-4 py-3 text-mastodon-text-primary font-medium hover:bg-mastodon-surface hover:text-mastodon-primary transition-colors rounded-full cursor-pointer">
             ...
             <button onClick={() => navigate('/debug')} className="flex items-center gap-4 px-4 py-3 text-gray-500 font-medium hover:bg-mastodon-surface hover:text-gray-300 transition-colors rounded-full mt-auto cursor-pointer">
